...
Note: Users can decide to opt-in/opt-out of receiving the activity summary email in their account preferences.',
  ...
  'option_explain.aiconnect_nav_bottom' => 'Adds an AI Connect icon button next to the RSS feed link in the page footer.',
  'option_explain.aiconnect_nav_top' => '<strong>Master switch</strong> for guest visibility. When disabled, guests cannot see the AI Connect navigation link or access the info page — regardless of the <em>viewAiConnect</em> permission.<br><br>When enabled, guest access is controlled by the <em>viewAiConnect</em> permission (Admin CP → User Groups → Permissions → AI Connect).<br><br>Logged-in users with <em>useTools</em> permission always see the link and can access the page, regardless of this setting.',
  'option_explain.aiconnect_pro_license_key' => 'Enter the license key you received in your purchase confirmation email (format: XFP-XXXX-XXXX-XXXX-XXXX). Leave blank to disable Pro features.',
  'option_explain.aiconnect_translation_provider' => 'Choose how translation works for AI agents connected to your forum.<br><br><b>AI Self-Translate</b> — The AI agent translates content using its own language abilities. No external API, no limits, best quality. <em>Recommended.</em><br><b>MyMemory API</b> — Uses the free <a href="https://mymemory.translated.net/" target="_blank">MyMemory</a> translation service. Limited to ~5,000 characters/day.<br><b>Disabled</b> — No translation capability offered to AI agents.',

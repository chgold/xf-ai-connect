...
namespace chgold\AIConnectAdmin\Admin\Controller;
 ...
 *   GET  aiconnect-admin/license/check  → renders a confirm form inside an overlay
 *   POST aiconnect-admin/license/check  → performs the remote validation, then
...
class License extends AbstractController
{
    ...
    {
        return $this->buildLink('options/groups', null) . 'aiconnect_admin_license/';
    }

    public function actionCheck(ParameterBag $params)
    {
        $validator = \chgold\AIConnectAdmin\License\Validator::class;
        ...
        return $this->view(
            'chgold\AIConnectAdmin:License\Check',
            'aiconnect_admin_license_check',
            $viewParams
        );
    }
